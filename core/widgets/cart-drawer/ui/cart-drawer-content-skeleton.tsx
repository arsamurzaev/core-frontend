    ...
    <>
      <ul className="space-y-4" aria-hidden>
        {Array.from(
          ...
          (_, index) => (
            <li key={index}>
              <div className="shadow-surface relative grid grid-flow-col grid-cols-[auto_1fr] items-center gap-2 overflow-hidden rounded-control pl-0 sm:grid-cols-[auto_1fr]">
                ...
                <div className="flex h-full items-center p-2 pl-0">
                  ...
                  <Skeleton className="h-10 w-26 rounded-pill" />
                </div>
              </div>
            </li>
          ),
      ...
      <div className="space-y-3" aria-hidden>
        ...
        <Skeleton className="h-[100px] w-full rounded-control" />
      </div>
    </>
  );
};
