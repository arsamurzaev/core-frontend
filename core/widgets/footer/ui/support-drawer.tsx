  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="currentColor"
      />
      <path d="M52 0.0528455H50.1259V1.79675H52V0.0528455Z" fill="currentColor" />
      <path d="M52 3.67276H50.1259V13H52V3.67276Z" fill="currentColor" />
      <path
      ...
      <path
        ...
        fill="currentColor"
      />
      <path d="M29.8274 11.2561V8.93089H31.5695V11.2561H29.8274Z" fill="currentColor" />
      <path
        ...
        fill="currentColor"
      />
      <path d="M26.9503 7.47764V7.31911H25.2609V7.47764H26.9503Z" fill="currentColor" />
    </svg>
  );
};
...
const LegacyDrawerBrand: React.FC = () => {
  return (
    <p className="text-text-muted flex flex-col items-center text-center text-sm">
...
const LegacyDrawerHeader: React.FC = () => {
  return (
    <DrawerHeader className="gap-y-5 pb-1 [&_svg]:size-5 [&_svg]:text-text-muted">
