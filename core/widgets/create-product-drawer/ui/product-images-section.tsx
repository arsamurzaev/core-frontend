...
import {
  ...
  type UploadState,
} from "@/core/widgets/create-product-drawer/model/types";
import { ProductImageGridItem } from "@/core/widgets/create-product-drawer/ui/product-image-grid-item";
  ...
  return (
    <section className="space-y-4 text-center">
      ...
      >
        ...
        {files.length === 0 ? "Добавить фото" : "Добавить еще фото"}
      </Button>
