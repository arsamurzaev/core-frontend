...
export const TypeControllerCreateResponse = zod.object({
  "id": zod.string(),
  "code": zod.string(),
  "name": zod.string(),
  "createdAt": zod.iso.datetime({"offset":true}).nullable(),
...
export const HandoffControllerExchangeResponse = zod.void()
...
export const AdminControllerGetDomainEventOutboxQueryParams = zod.object({
  "status": zod.enum(['PENDING', 'PROCESSING', 'PROCESSED', 'FAILED']).optional(),
  "catalogId": zod.uuid().optional(),
  "eventType": zod.string().optional(),
  "aggregateType": zod.string().optional(),
  "aggregateId": zod.string().optional(),
  "limit": zod.number().max(adminControllerGetDomainEventOutboxQueryLimitMax).default(adminControllerGetDomainEventOutboxQueryLimitDefault)
})

export const AdminControllerGetDomainEventOutboxResponse = zod.object({
  "total": zod.number(),
  "limit": zod.number(),
  ...
  "aggregateType": zod.string().nullish(),
  "aggregateId": zod.string().nullish(),
  "catalogId": zod.uuid(),
  "catalog": zod.object({
  "slug": zod.string(),
  "name": zod.string()
  ...
  "lockedAt": zod.iso.datetime({"offset":true}).nullish(),
...
export const AdminControllerGetDomainEventOutboxStatsResponse = zod.object({
  ...
  "oldestPendingAt": zod.iso.datetime({"offset":true}).nullish(),
  "newestFailedAt": zod.iso.datetime({"offset":true}).nullish(),
  "failedWithLastError": zod.number(),
  "processedRetentionDays": zod.number(),
  "processedRetentionCutoff": zod.iso.datetime({"offset":true}),
  "processedOlderThanRetention": zod.number(),
  "failedOlderThan1Day": zod.number(),
  "failedOlderThan7Days": zod.number(),
  "failedOlderThan30Days": zod.number()
})
...
export const AdminControllerRetryDomainEventOutboxItemResponse = zod.object({
  "processed": zod.number(),
  "failed": zod.number(),
  "skipped": zod.number(),
...
export const AdminControllerRetryFailedDomainEventsBody = zod.object({
  "catalogId": zod.uuid().optional(),
  "eventType": zod.string().optional(),
  "limit": zod.number().max(adminControllerRetryFailedDomainEventsBodyLimitMax).default(adminControllerRetryFailedDomainEventsBodyLimitDefault)
})

export const AdminControllerRetryFailedDomainEventsResponse = zod.object({
  "processed": zod.number(),
  "failed": zod.number(),
  "skipped": zod.number(),
  "matched": zod.number().optional()
...
export const adminControllerDrainDomainEventOutboxBodyMaxAttemptsDefault = 5;
export const adminControllerDrainDomainEventOutboxBodyMaxAttemptsMax = 50;

export const adminControllerDrainDomainEventOutboxBodyStaleProcessingMsDefault = 300000;

export const AdminControllerDrainDomainEventOutboxBody = zod.object({
  "limit": zod.number().max(adminControllerDrainDomainEventOutboxBodyLimitMax).default(adminControllerDrainDomainEventOutboxBodyLimitDefault),
  "maxAttempts": zod.number().max(adminControllerDrainDomainEventOutboxBodyMaxAttemptsMax).default(adminControllerDrainDomainEventOutboxBodyMaxAttemptsDefault),
  "staleProcessingMs": zod.number().default(adminControllerDrainDomainEventOutboxBodyStaleProcessingMsDefault)
})

export const AdminControllerDrainDomainEventOutboxResponse = zod.object({
  "processed": zod.number(),
  "failed": zod.number(),
  "skipped": zod.number(),
  "matched": zod.number().optional()
...
export const adminControllerCleanupDomainEventOutboxBodyLimitMax = 50000;



export const AdminControllerCleanupDomainEventOutboxBody = zod.object({
  "retentionDays": zod.number().default(adminControllerCleanupDomainEventOutboxBodyRetentionDaysDefault),
  "limit": zod.number().max(adminControllerCleanupDomainEventOutboxBodyLimitMax).default(adminControllerCleanupDomainEventOutboxBodyLimitDefault)
})

export const AdminControllerCleanupDomainEventOutboxResponse = zod.object({
  "deleted": zod.number(),
  "retentionDays": zod.number(),
  "cutoff": zod.iso.datetime({"offset":true}),
  "limit": zod.number()
})
 ...
 */
export const adminControllerGetCatalogsQuerySortByDefault = `createdAt`;
export const adminControllerGetCatalogsQuerySortOrderDefault = `desc`;
...
export const AdminControllerGetCatalogsResponseItem = zod.object({
  ...
  "deleteAt": zod.iso.datetime({"offset":true}).nullish(),
  "deleteInfo": zod.object({
  "isDeleted": zod.boolean(),
  "deletedAt": zod.iso.datetime({"offset":true}),
  "purgeAt": zod.iso.datetime({"offset":true}),
  ...
  "regionalities": zod.array(zod.object({
  "id": zod.string(),
  "code": zod.string(),
  "name": zod.string(),
  "countryId": zod.uuid().nullish(),
...
export const AdminControllerCreateCatalogResponse = zod.object({
  "catalog": zod.object({
  "id": zod.string(),
  "slug": zod.string(),
  "domain": zod.string().nullable(),
...
export const AdminControllerDuplicateCatalogResponse = zod.object({
  "catalog": zod.object({
  "id": zod.string(),
  "slug": zod.string(),
  "domain": zod.string().nullable(),
...
export const AdminControllerResetCatalogOwnerPasswordResponse = zod.object({
  "catalog": zod.object({
  "id": zod.string(),
  "slug": zod.string(),
  "domain": zod.string().nullable(),
...
export const adminControllerDiagnoseCatalogDefaultVariantsQuerySampleLimitDefault = 20;
export const adminControllerDiagnoseCatalogDefaultVariantsQuerySampleLimitMax = 100;



export const AdminControllerDiagnoseCatalogDefaultVariantsQueryParams = zod.object({
  "sampleLimit": zod.number().min(1).max(adminControllerDiagnoseCatalogDefaultVariantsQuerySampleLimitMax).default(adminControllerDiagnoseCatalogDefaultVariantsQuerySampleLimitDefault)
})

export const AdminControllerDiagnoseCatalogDefaultVariantsResponse = zod.object({
  "catalogId": zod.string(),
  "sampleLimit": zod.number(),
  "checks": zod.array(zod.object({
  "code": zod.enum(['SIMPLE_WITHOUT_DEFAULT_VARIANT', 'MULTIPLE_DEFAULT_VARIANTS', 'CUSTOM_VARIANT_WITHOUT_ATTRIBUTES', 'DEFAULT_VARIANT_WITH_ATTRIBUTES', 'DEFAULT_VARIANT_PRICE_MISMATCH']),
...
export const AdminControllerRepairCatalogMissingDefaultVariantsResponse = zod.object({
...
export const adminControllerRepairCatalogDefaultVariantPriceMismatchesBodyApplyDefault = false;
export const adminControllerRepairCatalogDefaultVariantPriceMismatchesBodyBatchSizeDefault = 100;
export const adminControllerRepairCatalogDefaultVariantPriceMismatchesBodyBatchSizeMax = 1000;

export const adminControllerRepairCatalogDefaultVariantPriceMismatchesBodySampleLimitDefault = 20;
export const adminControllerRepairCatalogDefaultVariantPriceMismatchesBodySampleLimitMax = 100;



export const AdminControllerRepairCatalogDefaultVariantPriceMismatchesBody = zod.object({
  "apply": zod.boolean().default(adminControllerRepairCatalogDefaultVariantPriceMismatchesBodyApplyDefault).describe('false = dry-run only. true = copy the technical default variant price into legacy Product.price for safe simple products.'),
  "batchSize": zod.number().min(1).max(adminControllerRepairCatalogDefaultVariantPriceMismatchesBodyBatchSizeMax).default(adminControllerRepairCatalogDefaultVariantPriceMismatchesBodyBatchSizeDefault),
  "sampleLimit": zod.number().min(1).max(adminControllerRepairCatalogDefaultVariantPriceMismatchesBodySampleLimitMax).default(adminControllerRepairCatalogDefaultVariantPriceMismatchesBodySampleLimitDefault)
})

export const AdminControllerRepairCatalogDefaultVariantPriceMismatchesResponse = zod.object({
  "catalogId": zod.string(),
  "dryRun": zod.boolean(),
  "checkedProducts": zod.number(),
  "repairableProducts": zod.number(),
  ...
  "previousProductPrice": zod.string().nullable(),
  "nextProductPrice": zod.string().nullable()
}))
})
...
export const AdminControllerGetCatalogMoySkladStockDiagnosticsResponse = zod.object({
  "catalogId": zod.string(),
  "integrationId": zod.string().nullable(),
  "hasIntegration": zod.boolean(),
  "integrationActive": zod.boolean(),
  "syncStockEnabled": zod.boolean(),
  "stockFieldOwnedByMoySklad": zod.boolean(),
  "stockWebhookEnabled": zod.boolean(),
  "stockWebhookRegistered": zod.boolean(),
  "lastStockSyncedAt": zod.iso.datetime({"offset":true}).nullable(),
  "links": zod.object({
  "productLinks": zod.number(),
  "variantLinks": zod.number(),
  "productLinksWithStockSync": zod.number(),
  "variantLinksWithStockSync": zod.number(),
  "productLinksMissing": zod.number(),
  "variantLinksMissing": zod.number(),
  "productLinksWithErrors": zod.number(),
  "variantLinksWithErrors": zod.number(),
  "productSkippedReasons": zod.array(zod.object({
  "reason": zod.string(),
  "count": zod.number()
})),
  "variantSkippedReasons": zod.array(zod.object({
  "reason": zod.string(),
  "count": zod.number()
}))
}),
  ...
  "appliedRows": zod.number(),
  "skippedRows": zod.number(),
  "diagnostics": zod.object({
  "source": zod.enum(['FULL_SYNC', 'WEBHOOK']),
  "stockRows": zod.number(),
  "matchedStockRows": zod.number(),
  "unmatchedStockRows": zod.number(),
  "productLinks": zod.number(),
  "variantLinks": zod.number(),
  "ignoredVariantLinks": zod.number(),
  "appliedProductLinks": zod.number(),
  "appliedVariantLinks": zod.number(),
  "skippedReasons": zod.object({
  "missingStock": zod.number(),
  "productHasVariantLinks": zod.number(),
  "variantsCapabilityDisabled": zod.number(),
  "stockRowWithoutLocalLink": zod.number()
})
}).nullable(),
...
export const AdminControllerGetGeoAdminsResponse = zod.array(AdminControllerGetGeoAdminsResponseItem)
...
export const AdminControllerCreateGeoAdminBody = zod.object({
  ...
  "password": zod.string().optional().describe('If omitted, password is generated automatically.'),
  "name": zod.string(),
  "countryIds": zod.array(zod.uuid()).optional(),
  "regionalityIds": zod.array(zod.uuid()).optional()
})

export const AdminControllerCreateGeoAdminResponse = zod.object({
  "admin": zod.object({
  "id": zod.string(),
  "login": zod.string(),
  "name": zod.string(),
...
export const AdminControllerGetRegionalitiesResponse = zod.array(AdminControllerGetRegionalitiesResponseItem)
...
export const AdminControllerCreateRegionalityBody = zod.object({
  ...
  "parentId": zod.uuid().nullish().describe('Parent region id for nested regional directories.'),
  "countryName": zod.string().optional().describe('Required when countryId is not provided.'),
  "countryCode": zod.string().optional().describe('If omitted, generated from countryName.'),
  "regionName": zod.string(),
  "regionCode": zod.string().optional().describe('If omitted, generated from countryCode and regionName.')
})

export const AdminControllerCreateRegionalityResponse = zod.object({
  "id": zod.string(),
  "code": zod.string(),
  "name": zod.string(),
  "countryId": zod.uuid().nullish(),
...
export const AdminControllerGetCountriesResponse = zod.array(AdminControllerGetCountriesResponseItem)
...
export const AdminControllerCreateCountryBody = zod.object({
  "name": zod.string(),
  "code": zod.string().optional().describe('If omitted, generated from name.')
})

export const AdminControllerCreateCountryResponse = zod.object({
  "id": zod.string(),
  "code": zod.string(),
  "name": zod.string(),
  "deleteAt": zod.iso.datetime({"offset":true}).nullish()
...
export const AdminControllerCreateActivityResponse = zod.object({
  "id": zod.string(),
  "name": zod.string(),
  "deleteAt": zod.iso.datetime({"offset":true}).nullish(),
  "deleteInfo": zod.object({
...
export const AdminControllerCreatePromoCodeResponse = zod.object({
  "id": zod.string(),
  "name": zod.string(),
  "firstName": zod.string(),
  "lastName": zod.string(),
...
export const AdminControllerGetCatalogPaymentsResponseItem = zod.object({
  ...
  "catalogId": zod.string(),
  "promoCodeId": zod.string().nullable(),
  "paidAt": zod.iso.datetime({"offset":true}).nullish(),
  "amount": zod.number().nullish(),
  "licenseEndsAt": zod.iso.datetime({"offset":true}).nullish(),
...
export const AdminControllerCreateCatalogPromoPaymentBody = zod.object({
  ...
  "paidAt": zod.iso.datetime({"offset":true}).optional(),
  "licenseEndsAt": zod.iso.datetime({"offset":true}).optional(),
  "proof": zod.instanceof(File)
})

export const AdminControllerCreateCatalogPromoPaymentResponse = zod.object({
  "id": zod.string(),
  "kind": zod.enum(['SUBSCRIPTION', 'PROMOCODE']),
  "catalogId": zod.string(),
  "promoCodeId": zod.string().nullable(),
...
export const AdminControllerCreateCatalogSubscriptionPaymentResponse = zod.object({
  "id": zod.string(),
  "kind": zod.enum(['SUBSCRIPTION', 'PROMOCODE']),
  "catalogId": zod.string(),
  "promoCodeId": zod.string().nullable(),
...
export const AdminSsoControllerEnterResponse = zod.void()
...
export const S3ControllerPresignUploadResponse = zod.object({
  "ok": zod.boolean(),
  "mediaId": zod.string(),
...
export const S3ControllerPresignPostUploadResponse = zod.object({
  "ok": zod.boolean(),
  "mediaId": zod.string(),
  "uploadUrl": zod.string(),
  "fields": zod.looseObject({
...
export const S3ControllerStartMultipartResponse = zod.object({
  "ok": zod.boolean(),
  "mediaId": zod.string(),
  "uploadId": zod.string(),
  "key": zod.string(),
...
export const S3ControllerPresignMultipartPartResponse = zod.object({
  "ok": zod.boolean(),
  "partNumber": zod.number(),
  "uploadUrl": zod.string()
})
...
export const S3ControllerCompleteMultipartResponse = zod.object({
  "ok": zod.boolean(),
  "key": zod.string(),
  "jobId": zod.string(),
  "count": zod.number()
...
export const S3ControllerAbortMultipartResponse = zod.void()
...
export const S3ControllerEnqueueFromS3Response = zod.object({
  "ok": zod.boolean(),
  "jobId": zod.string(),
  "count": zod.number()
})
...
export const ProductControllerGetAllResponseItem = zod.object({
  ...
  "priceState": zod.enum(['UNKNOWN', 'KNOWN', 'RANGE']),
  "displayPrice": zod.string().nullable(),
  "minPrice": zod.string().nullable(),
  "maxPrice": zod.string().nullable(),
  "availabilityState": zod.enum(['AVAILABLE', 'OUT_OF_STOCK', 'UNAVAILABLE']),
  ...
  "requiresVariantSelection": zod.boolean(),
  ...
  "valueDateTime": zod.iso.datetime({"offset":true}).nullable(),
  ...
  "totalStock": zod.number().nullable(),
 ...
 */
export const productControllerCreateBodyAttributesItemValueStringMax = 3000;
...
export const ProductControllerCreateBody = zod.object({
  ...
  "valueString": zod.string().max(productControllerCreateBodyAttributesItemValueStringMax).optional(),
  "valueInteger": zod.number().optional(),
  "valueDecimal": zod.number().optional(),
  "valueBoolean": zod.boolean().optional(),
  "valueDateTime": zod.iso.datetime({"offset":true}).optional()
})).optional(),
  "saleUnits": zod.array(zod.object({
 ...
 */
export const ProductControllerDiagnoseDefaultVariantsQueryParams = zod.object({
  "sampleLimit": zod.number().optional().describe('Max samples per diagnostic check, default 10, max 100.')
})

export const ProductControllerDiagnoseDefaultVariantsResponse = zod.object({
  "catalogId": zod.string(),
  "sampleLimit": zod.number(),
  "checks": zod.array(zod.object({
  "code": zod.enum(['SIMPLE_WITHOUT_DEFAULT_VARIANT', 'MULTIPLE_DEFAULT_VARIANTS', 'CUSTOM_VARIANT_WITHOUT_ATTRIBUTES', 'DEFAULT_VARIANT_WITH_ATTRIBUTES', 'DEFAULT_VARIANT_PRICE_MISMATCH']),
...
export const productControllerUpdateBodyAttributesItemValueStringMax = 3000;
...
export const ProductControllerUpdateBody = zod.object({
  ...
  "attributeId": zod.string(),
  "enumValueId": zod.string().optional(),
  "valueString": zod.string().max(productControllerUpdateBodyAttributesItemValueStringMax).optional(),
  "valueInteger": zod.number().optional(),
  "valueDecimal": zod.number().optional(),
  "valueBoolean": zod.boolean().optional(),
  "valueDateTime": zod.iso.datetime({"offset":true}).optional()
  ...
  "variantMatrix": zod.array(zod.object({
  "price": zod.number().nullish(),
  "stock": zod.number().nullish().describe('null означает, что остаток не ведется'),
  "isAvailable": zod.boolean().optional(),
  "status": zod.enum(['ACTIVE', 'OUT_OF_STOCK', 'DISABLED']).optional(),
...
})).optional().describe('Full variant matrix replacement applied atomically with product update.')
})
...
export const ProductControllerDuplicateResponse = zod.object({
  "id": zod.string(),
  "sku": zod.string(),
  "name": zod.string(),
  "slug": zod.string(),
 ...
 */
export const productControllerRepairDefaultVariantPriceMismatchesBodyApplyDefault = false;
export const productControllerRepairDefaultVariantPriceMismatchesBodyBatchSizeDefault = 100;
export const productControllerRepairDefaultVariantPriceMismatchesBodyBatchSizeMax = 1000;

export const productControllerRepairDefaultVariantPriceMismatchesBodySampleLimitDefault = 20;
export const productControllerRepairDefaultVariantPriceMismatchesBodySampleLimitMax = 100;



export const ProductControllerRepairDefaultVariantPriceMismatchesBody = zod.object({
  "apply": zod.boolean().default(productControllerRepairDefaultVariantPriceMismatchesBodyApplyDefault).describe('false = dry-run only. true = copy the technical default variant price into legacy Product.price for safe simple products.'),
  "batchSize": zod.number().min(1).max(productControllerRepairDefaultVariantPriceMismatchesBodyBatchSizeMax).default(productControllerRepairDefaultVariantPriceMismatchesBodyBatchSizeDefault),
  "sampleLimit": zod.number().min(1).max(productControllerRepairDefaultVariantPriceMismatchesBodySampleLimitMax).default(productControllerRepairDefaultVariantPriceMismatchesBodySampleLimitDefault)
})

export const ProductControllerRepairDefaultVariantPriceMismatchesResponse = zod.object({
  "catalogId": zod.string(),
  "dryRun": zod.boolean(),
  "checkedProducts": zod.number(),
  "repairableProducts": zod.number(),
...
export const productControllerApplyProductTypeChangeBodyAttributesItemValueStringMax = 3000;
...
export const ProductControllerApplyProductTypeChangeBody = zod.object({
  ...
  "attributeId": zod.string(),
  "enumValueId": zod.string().optional(),
  "valueString": zod.string().max(productControllerApplyProductTypeChangeBodyAttributesItemValueStringMax).optional(),
  "valueInteger": zod.number().optional(),
  "valueDecimal": zod.number().optional(),
  "valueBoolean": zod.boolean().optional(),
  "valueDateTime": zod.iso.datetime({"offset":true}).optional()
...
export const AttributeControllerCreateResponse = zod.object({
  "id": zod.string(),
  "typeIds": zod.array(zod.string()),
  "key": zod.string(),
  "displayName": zod.string(),
...
export const AttributeControllerCreateEnumValueResponse = zod.object({
  "id": zod.string(),
  "attributeId": zod.string(),
  "catalogId": zod.string().nullable(),
  "value": zod.string(),
...
export const AttributeControllerCreateEnumValueAliasResponse = zod.object({
  "id": zod.string(),
  "attributeId": zod.string(),
  "catalogId": zod.string().nullable(),
  "enumValueId": zod.string(),
...
export const BrandControllerCreateResponse = zod.object({
  "id": zod.string(),
  "catalogId": zod.string(),
  "name": zod.string(),
  "slug": zod.string(),
...
export const CatalogAdvancedSettingsControllerListDomainsResponseItem = zod.object({
  ...
  "nextCheckAt": zod.iso.datetime({"offset":true}),
  "message": zod.string(),
...
export const CatalogAdvancedSettingsControllerCreateDomainResponse = zod.object({
  "id": zod.string(),
  "catalogId": zod.string(),
  "hostname": zod.string(),
  "status": zod.enum(['PENDING_DNS', 'DNS_VERIFIED', 'ACTIVE', 'FAILED', 'DISABLED']),
 ...
 */
export const CatalogAdvancedSettingsControllerListSaleUnitsQueryParams = zod.object({
  "includeInactive": zod.boolean().optional().describe('Include disabled, non-archived units.'),
  "includeArchived": zod.boolean().optional().describe('Include archived units.')
})

export const CatalogAdvancedSettingsControllerListSaleUnitsResponseItem = zod.object({
  "id": zod.string(),
  "catalogId": zod.string(),
  "code": zod.string(),
  "name": zod.string(),
...
export const CatalogAdvancedSettingsControllerListSaleUnitsResponse = zod.array(CatalogAdvancedSettingsControllerListSaleUnitsResponseItem)


/**
 * @summary Create advanced settings catalog sale unit
 */
export const CatalogAdvancedSettingsControllerCreateSaleUnitBody = zod.object({
...
export const CatalogAdvancedSettingsControllerCreateSaleUnitResponse = zod.object({
  "id": zod.string(),
  "catalogId": zod.string(),
  "code": zod.string(),
  "name": zod.string(),
 ...
 */
export const CatalogAdvancedSettingsControllerGetSaleUnitParams = zod.object({
  "id": zod.string()
})

export const CatalogAdvancedSettingsControllerGetSaleUnitResponse = zod.object({
  "id": zod.string(),
  "catalogId": zod.string(),
  "code": zod.string(),
  "name": zod.string(),
 ...
 */
export const CatalogAdvancedSettingsControllerUpdateSaleUnitParams = zod.object({
  "id": zod.string()
})

export const CatalogAdvancedSettingsControllerUpdateSaleUnitBody = zod.object({
  "name": zod.string().optional().describe('Название формата продажи внутри текущего каталога.'),
  "code": zod.string().optional().describe('Технический код можно не передавать: backend создаст его сам.'),
  "defaultBaseQuantity": zod.number().optional().describe('Подсказка количества внутри. Конкретный товар все равно хранит свое количество.'),
  "barcode": zod.string().optional(),
  "displayOrder": zod.number().optional(),
  "isActive": zod.boolean().optional().describe('Soft availability switch for admin dictionaries. Existing product bindings are preserved.')
})

export const CatalogAdvancedSettingsControllerUpdateSaleUnitResponse = zod.object({
  "id": zod.string(),
  "catalogId": zod.string(),
  "code": zod.string(),
  "name": zod.string(),
 ...
 */
export const CatalogAdvancedSettingsControllerArchiveSaleUnitParams = zod.object({
  "id": zod.string()
})

export const CatalogAdvancedSettingsControllerArchiveSaleUnitResponse = zod.object({
  "ok": zod.boolean()
})
...
export const CatalogAdvancedSettingsControllerGetMoySkladResponse = zod.object({
  ...
  "fieldOwnership": zod.object({
  "price": zod.enum(['external', 'local']),
  "stock": zod.enum(['external', 'local']),
  "content": zod.enum(['external', 'local']),
  "images": zod.enum(['external', 'local'])
}),
  ...
  "lastReceivedAt": zod.iso.datetime({"offset":true}).nullable(),
  "lastProcessedAt": zod.iso.datetime({"offset":true}).nullable(),
  ...
  "syncStartedAt": zod.iso.datetime({"offset":true}).nullable(),
...
export const CatalogAdvancedSettingsControllerUpsertMoySkladBody = zod.object({
  ...
  "fieldOwnership": zod.object({
  "price": zod.enum(['external', 'local']).optional(),
  "stock": zod.enum(['external', 'local']).optional(),
  "content": zod.enum(['external', 'local']).optional(),
  "images": zod.enum(['external', 'local']).optional()
}).optional(),
...
export const CatalogAdvancedSettingsControllerGetIikoResponse = zod.object({
  ...
  "externalMenuName": zod.string().nullable(),
  "priceCategoryId": zod.string().nullable(),
  "priceCategoryName": zod.string().nullable(),
  "terminalGroupId": zod.string().nullable(),
  "terminalGroupName": zod.string().nullable(),
  "menuVersion": zod.number(),
  "syncSource": zod.string(),
  "importImages": zod.boolean(),
  "exportOrders": zod.boolean(),
  "webhook": zod.object({
  "enabled": zod.boolean(),
  "urlPreview": zod.string().nullable(),
  "hasSecret": zod.boolean(),
  "lastConfiguredAt": zod.iso.datetime({"offset":true}).nullable(),
  "lastReceivedAt": zod.iso.datetime({"offset":true}).nullable(),
  "lastEventType": zod.string().nullable(),
  "lastError": zod.string().nullable()
}),
  "orderExportServiceType": zod.enum(['DeliveryByCourier', 'DeliveryByClient']).nullable(),
  "orderExportSourceKey": zod.string().nullable(),
  "lastRevision": zod.number().nullable(),
  "lastMenuSyncedAt": zod.iso.datetime({"offset":true}).nullable(),
  "lastStopListSyncedAt": zod.iso.datetime({"offset":true}).nullable(),
  "lastSyncStatus": zod.enum(['IDLE', 'SYNCING', 'SUCCESS', 'ERROR']),
  "syncStartedAt": zod.iso.datetime({"offset":true}).nullable(),
  "lastSyncAt": zod.iso.datetime({"offset":true}).nullable(),
  "lastSyncError": zod.string().nullable(),
...
export const CatalogAdvancedSettingsControllerUpsertIikoBody = zod.object({
  ...
  "priceCategoryId": zod.string().nullish(),
  "priceCategoryName": zod.string().nullish(),
  "terminalGroupId": zod.string().nullish(),
  "terminalGroupName": zod.string().nullish(),
  "menuVersion": zod.number().optional(),
  "isActive": zod.boolean().optional(),
  "importImages": zod.boolean().optional(),
  "exportOrders": zod.boolean().optional(),
  "orderExportServiceType": zod.enum(['DeliveryByCourier', 'DeliveryByClient']).nullish(),
  "orderExportSourceKey": zod.string().nullish()
})
 ...
 */
export const CatalogAdvancedSettingsControllerRemoveIikoResponse = zod.object({
  "ok": zod.boolean()
})
 ...
 */
export const CatalogAdvancedSettingsControllerGetIikoRunsQueryParams = zod.object({
...
export const CatalogAdvancedSettingsControllerGetIikoRunsResponse = zod.array(CatalogAdvancedSettingsControllerGetIikoRunsResponseItem)


/**
 * @summary Get advanced settings iiko webhook journal
 */
export const CatalogAdvancedSettingsControllerGetIikoWebhookEventsQueryParams = zod.object({
  "limit": zod.number().optional().describe('How many recent webhook events to return'),
  "status": zod.string().optional().describe('Optional webhook event status filter')
})
...
export const CatalogAdvancedSettingsControllerGetIikoWebhookEventsResponseItem = zod.object({
  ...
  "processedAt": zod.iso.datetime({"offset":true}).nullable(),
  "createdAt": zod.iso.datetime({"offset":true}),
  "updatedAt": zod.iso.datetime({"offset":true})
})
export const CatalogAdvancedSettingsControllerGetIikoWebhookEventsResponse = zod.array(CatalogAdvancedSettingsControllerGetIikoWebhookEventsResponseItem)


/**
 * @summary Retry advanced settings iiko webhook event
 */
export const CatalogAdvancedSettingsControllerRetryIikoWebhookEventParams = zod.object({
  "eventId": zod.string()
})
 ...
 */
export const CatalogAdvancedSettingsControllerGetIikoRunProgressParams = zod.object({
  "runId": zod.string()
})

export const CatalogAdvancedSettingsControllerGetIikoRunProgressResponse = zod.object({
  "runId": zod.string(),
  "status": zod.enum(['PENDING', 'RUNNING', 'SUCCESS', 'ERROR', 'SKIPPED']),
  "phase": zod.string(),
  "message": zod.string(),
...
export const CatalogAdvancedSettingsControllerTestIikoConnectionResponse = zod.object({
  ...
  "id": zod.string(),
  "name": zod.string(),
  "isActive": zod.boolean().nullable()
})),
  "externalMenus": zod.array(zod.object({
  "id": zod.string(),
  "name": zod.string()
})),
  "priceCategories": zod.array(zod.object({
  "id": zod.string(),
  "name": zod.string()
})),
  "terminalGroups": zod.array(zod.object({
  "id": zod.string(),
  "name": zod.string(),
  "organizationId": zod.string().nullable(),
  "isActive": zod.boolean().nullable(),
  "isAlive": zod.boolean().nullable()
}))
})
...
export const CatalogAdvancedSettingsControllerPreviewIikoImportResponse = zod.object({
  "ok": zod.boolean(),
  "source": zod.string(),
  "revision": zod.number().nullable(),
  "externalMenuId": zod.string().nullable(),
  "externalMenuName": zod.string().nullable(),
  "stats": zod.object({
  "categories": zod.number(),
  "items": zod.number(),
  "visibleItems": zod.number(),
  "hiddenItems": zod.number(),
  "itemsWithoutPrice": zod.number(),
  "itemsWithModifiers": zod.number(),
  "combos": zod.number(),
  "variants": zod.number()
}),
  "diff": zod.object({
  "newItems": zod.number(),
  "matchedItems": zod.number(),
  "changedItems": zod.number(),
  "priceChanges": zod.number(),
  "nameChanges": zod.number(),
  "unchangedItems": zod.number(),
  "missingLinkedItems": zod.number()
}),
  "categories": zod.array(zod.object({
  "id": zod.string(),
  "name": zod.string(),
  ...
  "orderItemType": zod.string().nullable(),
  "isHidden": zod.boolean(),
  "hasPrice": zod.boolean(),
  "price": zod.number().nullable(),
  "variants": zod.number(),
  "hasModifiers": zod.boolean(),
  "willImport": zod.boolean(),
  "skipReasons": zod.array(zod.string()),
  "diffStatus": zod.string().nullable(),
  "localProductId": zod.string().nullable(),
  "localName": zod.string().nullable(),
  "localPrice": zod.number().nullable()
}))
})
 ...
 */
export const CatalogAdvancedSettingsControllerSyncIikoCatalogResponse = zod.object({
  "ok": zod.boolean(),
  "queued": zod.boolean(),
  "runId": zod.string(),
  "jobId": zod.string(),
 ...
 */
export const CatalogAdvancedSettingsControllerSyncIikoStockResponse = zod.object({
  "ok": zod.boolean(),
  "queued": zod.boolean(),
  "runId": zod.string(),
  "jobId": zod.string(),
 ...
 */
export const CatalogAdvancedSettingsControllerSyncIikoProductParams = zod.object({
  "id": zod.string().describe('Local product ID')
})

export const CatalogAdvancedSettingsControllerSyncIikoProductResponse = zod.object({
  "ok": zod.boolean(),
  "queued": zod.boolean(),
  "runId": zod.string(),
  "jobId": zod.string(),
 ...
 */
export const CatalogAdvancedSettingsControllerSetupIikoWebhooksResponse = zod.object({
  "ok": zod.boolean(),
  "enabled": zod.boolean(),
 ...
 */
export const CatalogAdvancedSettingsControllerDisableIikoWebhooksResponse = zod.object({
  "ok": zod.boolean()
})
...
export const CatalogControllerCreateResponse = zod.object({
  "ok": zod.boolean(),
  "id": zod.string(),
  "slug": zod.string(),
  "domain": zod.string().nullable()
...
export const CatalogDomainControllerCreateResponse = zod.object({
  "id": zod.string(),
  "catalogId": zod.string(),
  "hostname": zod.string(),
  "status": zod.enum(['PENDING_DNS', 'DNS_VERIFIED', 'ACTIVE', 'FAILED', 'DISABLED']),
 ...
 */
export const IntegrationControllerRemoveIikoResponse = zod.object({
  "ok": zod.boolean()
})
 ...
 */
export const IntegrationControllerGetIikoTablesResponse = zod.object({
  "ok": zod.boolean(),
  "tables": zod.array(zod.object({
  "id": zod.string(),
  "publicCode": zod.string().nullable(),
  "number": zod.number().nullable(),
  "displayNumber": zod.string().nullable(),
  "name": zod.string().nullable(),
  "seatingCapacity": zod.number().nullable(),
...
export const IntegrationControllerPreviewIikoImportResponse = zod.object({
  "ok": zod.boolean(),
  "source": zod.string(),
  "revision": zod.number().nullable(),
  "externalMenuId": zod.string().nullable(),
 ...
 */
export const IntegrationControllerSyncIikoCatalogResponse = zod.object({
  "ok": zod.boolean(),
  "queued": zod.boolean(),
  "runId": zod.string(),
  "jobId": zod.string(),
 ...
 */
export const IntegrationControllerSyncIikoStockResponse = zod.object({
  "ok": zod.boolean(),
  "queued": zod.boolean(),
  "runId": zod.string(),
  "jobId": zod.string(),
 ...
 */
export const IntegrationControllerSyncIikoProductParams = zod.object({
  "id": zod.string().describe('Local product ID')
})

export const IntegrationControllerSyncIikoProductResponse = zod.object({
  "ok": zod.boolean(),
  "queued": zod.boolean(),
  "runId": zod.string(),
  "jobId": zod.string(),
 ...
 */
export const IntegrationControllerSetupIikoWebhooksResponse = zod.object({
  "ok": zod.boolean(),
  "enabled": zod.boolean(),
  "correlationId": zod.string(),
  "webhook": zod.object({
 ...
 */
export const IntegrationControllerDisableIikoWebhooksResponse = zod.object({
  "ok": zod.boolean()
})
 ...
 */
export const IntegrationControllerGetIikoRunsQueryParams = zod.object({
  "limit": zod.number().optional().describe('How many recent sync runs to return')
})
...
export const IntegrationControllerGetIikoRunsResponse = zod.array(IntegrationControllerGetIikoRunsResponseItem)


/**
 * @summary Get iiko sync progress
 */
export const IntegrationControllerGetIikoRunProgressParams = zod.object({
  "runId": zod.string()
})

export const IntegrationControllerGetIikoRunProgressResponse = zod.object({
  "runId": zod.string(),
  "status": zod.enum(['PENDING', 'RUNNING', 'SUCCESS', 'ERROR', 'SKIPPED']),
  "phase": zod.string(),
  "message": zod.string(),
 ...
 */
export const IntegrationControllerGetIikoOrderExportsQueryParams = zod.object({
  "limit": zod.number().optional().describe('How many recent order exports to return')
})
...
export const IntegrationControllerGetIikoOrderExportsResponseItem = zod.object({
  ...
  "requestedAt": zod.iso.datetime({"offset":true}),
  "startedAt": zod.iso.datetime({"offset":true}).nullable(),
  "exportedAt": zod.iso.datetime({"offset":true}).nullable(),
  "createdAt": zod.iso.datetime({"offset":true}),
  "updatedAt": zod.iso.datetime({"offset":true})
})
export const IntegrationControllerGetIikoOrderExportsResponse = zod.array(IntegrationControllerGetIikoOrderExportsResponseItem)


/**
 * @summary Get iiko webhook event journal
 */
export const IntegrationControllerGetIikoWebhookEventsQueryParams = zod.object({
  "status": zod.string().optional().describe('Optional webhook event status filter'),
  "limit": zod.number().optional().describe('How many recent webhook events to return')
})
...
export const IntegrationControllerGetIikoWebhookEventsResponse = zod.array(IntegrationControllerGetIikoWebhookEventsResponseItem)


/**
 * @summary Retry failed iiko webhook event processing
 */
export const IntegrationControllerRetryIikoWebhookEventParams = zod.object({
  "eventId": zod.string()
})
...
export const IntegrationControllerReceiveMoySkladStockWebhookResponse = zod.void()


/**
 * @summary Receive MoySklad product delete webhook
 */
export const IntegrationControllerReceiveMoySkladProductDeleteWebhookParams = zod.object({
  "integrationId": zod.string(),
  "secret": zod.string()
})

export const IntegrationControllerReceiveMoySkladProductDeleteWebhookResponse = zod.void()


/**
 * @summary Receive MoySklad product change webhook
 */
export const IntegrationControllerReceiveMoySkladProductChangeWebhookParams = zod.object({
  "integrationId": zod.string(),
  "secret": zod.string()
})

export const IntegrationControllerReceiveMoySkladProductChangeWebhookResponse = zod.void()


/**
 * @summary Receive MoySklad product folder webhook
 */
export const IntegrationControllerReceiveMoySkladProductFolderWebhookParams = zod.object({
  "integrationId": zod.string(),
  "secret": zod.string()
})

export const IntegrationControllerReceiveMoySkladProductFolderWebhookResponse = zod.void()


/**
 * @summary Receive iikoCloud webhook
 */
export const IntegrationControllerReceiveIikoWebhookParams = zod.object({
  "integrationId": zod.string(),
  "secret": zod.string()
})

export const IntegrationControllerReceiveIikoWebhookResponse = zod.void()
 ...
 */
export const IntegrationControllerRetryIikoOrderExportParams = zod.object({
  "id": zod.string().describe('IntegrationOrderExport record id')
})

export const IntegrationControllerRetryIikoOrderExportResponse = zod.object({
  "ok": zod.boolean(),
  "queued": zod.boolean(),
  "exportId": zod.string().nullable(),
  "jobId": zod.string().nullable(),
 ...
 */
export const IntegrationControllerGetIikoOrderExportTimelineParams = zod.object({
  "orderId": zod.string()
})

export const IntegrationControllerGetIikoOrderExportTimelineResponse = zod.object({
  "orderId": zod.string(),
  "items": zod.array(zod.object({
  "id": zod.string(),
  "provider": zod.enum(['MOYSKLAD', 'IIKO', 'ONE_C']),
...
export const OneCIntegrationControllerGetOneCResponse = zod.object({
  ...
  "syncStartedAt": zod.iso.datetime({"offset":true}).nullable(),
  "lastSyncAt": zod.iso.datetime({"offset":true}).nullable(),
  "lastDiscoveredAt": zod.iso.datetime({"offset":true}).nullable(),
  "lastSyncError": zod.string().nullable(),
  "totalProducts": zod.number(),
  "createdProducts": zod.number(),
  "updatedProducts": zod.number(),
...
export const OneCIntegrationControllerGetOneCRecommendedProductMappingResponse = zod.object({
  ...
  "schema": zod.looseObject({

}).nullable(),
  "sample": zod.looseObject({
...
/**
 * @summary Get recommended ONE_C STOCK mapping
 */
export const OneCIntegrationControllerGetOneCRecommendedStockMappingResponse = zod.object({
  "ok": zod.boolean(),
  "ready": zod.boolean(),
  "mappingId": zod.string().nullable(),
  "mapping": zod.object({
...
/**
 * @summary Get recommended ONE_C PRICE mapping
 */
export const OneCIntegrationControllerGetOneCRecommendedPriceMappingResponse = zod.object({
  "ok": zod.boolean(),
  "ready": zod.boolean(),
  "mappingId": zod.string().nullable(),
  "mapping": zod.object({
...
export const OneCIntegrationControllerPreviewOneCMappingBody = zod.object({
  "entityMappingId": zod.string(),
  "externalPayload": zod.looseObject({
...
export const OneCIntegrationControllerPreviewOneCMappingResponse = zod.object({
  ...
  "externalPath": zod.string(),
  "dataType": zod.enum(['STRING', 'INTEGER', 'DECIMAL', 'BOOLEAN', 'DATETIME', 'JSON', 'REFERENCE']),
  "externalValue": zod.looseObject({

}).nullable(),
  "mappedValue": zod.looseObject({
...
export const OneCIntegrationControllerPreviewOneCProductImportResponse = zod.object({
  ...
  "mapped": zod.looseObject({

}),
  "changes": zod.array(zod.object({
  "field": zod.string(),
  "currentValue": zod.looseObject({

}).nullable(),
  "nextValue": zod.looseObject({
...
export const CatalogSaleUnitControllerCreateResponse = zod.object({
  "id": zod.string(),
  "catalogId": zod.string(),
  "code": zod.string(),
  "name": zod.string(),
...
export const CategoryControllerCreateResponse = zod.object({
  "id": zod.string(),
  "catalogId": zod.string(),
  "parentId": zod.string().nullable(),
  "position": zod.number(),
...
export const InventoryControllerCreateWarehouseResponse = zod.object({
  "id": zod.string(),
  "name": zod.string(),
  "code": zod.string(),
  "status": zod.enum(['ACTIVE', 'DISABLED']),
...
export const InventoryControllerGetWarehouseReservationsResponseItem = zod.object({
  ...
  "consumedAt": zod.iso.datetime({"offset":true}).nullish(),
  "releasedAt": zod.iso.datetime({"offset":true}).nullish(),
  "variant": zod.object({
  "id": zod.string(),
  "sku": zod.string(),
  "variantKey": zod.string(),
...
export const InventoryControllerAdjustWarehouseStockResponse = zod.object({
  "ok": zod.boolean(),
  "balance": zod.object({
  "id": zod.string(),
  "warehouseId": zod.string(),
...
export const CartControllerCreateOrGetCurrentResponse = zod.object({
  ...
  "statusChangedAt": zod.iso.datetime({"offset":true}),
  "publicKey": zod.string().nullable(),
  "checkoutAt": zod.iso.datetime({"offset":true}).nullable(),
  "comment": zod.string().nullable(),
  "checkoutMethod": zod.enum(['DELIVERY', 'PICKUP', 'PREORDER']).nullable(),
  "checkoutData": zod.looseObject({

}).nullable(),
  "checkoutContacts": zod.looseObject({

}).nullable(),
  "assignedManagerId": zod.uuid().nullable(),
  "managerSessionStartedAt": zod.iso.datetime({"offset":true}).nullable(),
  "managerLastSeenAt": zod.iso.datetime({"offset":true}).nullable(),
...
export const CartControllerSubmitCurrentHallOrderBody = zod.object({
  "comment": zod.string().max(cartControllerSubmitCurrentHallOrderBodyCommentMax).optional(),
  "checkoutMethod": zod.enum(['DELIVERY', 'PICKUP', 'PREORDER']).optional(),
  "checkoutData": zod.looseObject({
...
export const CartControllerSubmitCurrentHallOrderResponse = zod.object({
  "ok": zod.boolean(),
  "order": zod.object({
  "id": zod.uuid(),
...
export const CartControllerJoinHallTableSessionBody = zod.object({
  ...
  "guestToken": zod.string().optional().describe('Private token proving ownership of guestSessionId'),
...
export const CartControllerJoinHallTableSessionResponse = zod.object({
  ...
  "publicKey": zod.string(),
  "guestSessionId": zod.string().nullable(),
  "guestToken": zod.string().describe('Private token required to mutate this guest lines')
})
})
...
export const ProductTypeControllerCreateResponse = zod.object({
  "id": zod.string(),
  "catalogId": zod.string().nullable(),
  "scope": zod.enum(['SYSTEM_TEMPLATE', 'CATALOG']),
  "code": zod.string(),
...
export const ProductTypeControllerCreateSystemTemplateResponse = zod.object({
  "id": zod.string(),
  "catalogId": zod.string().nullable(),
  "scope": zod.enum(['SYSTEM_TEMPLATE', 'CATALOG']),
  "code": zod.string(),
...
export const ProductTypeControllerCreateFromTemplateResponse = zod.object({
  "id": zod.string(),
  "catalogId": zod.string().nullable(),
  "scope": zod.enum(['SYSTEM_TEMPLATE', 'CATALOG']),
  "code": zod.string(),
